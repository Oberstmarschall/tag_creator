...
def parse() -> argparse.Namespace:
    ...
    parser.add_argument("--release_branch", help="Release branch. (default: %(default)s)", required=False, default="main")
    ...
    parser.add_argument("--tag_prefix", help="Prefix of version number. (default: %(default)s)", required=False, default="")
